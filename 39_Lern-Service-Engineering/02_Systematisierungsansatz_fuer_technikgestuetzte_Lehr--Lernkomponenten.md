...
In jüngster Zeit erfahren diese drei Typen eine transformative Erweiterung durch den Einsatz von Generativer Künstlicher Intelligenz (GenAI) und Large Language Models (LLMs). Die künstliche Intelligenz (KI) fungiert hierbei als Effizienztreiber, der die Grenzen zwischen den Kategorien verschwimmen lässt.

- Bei **WBTs** ermöglichen LLMs die automatisierte Erstellung von Skripten, Storyboards und interaktiven Quizfragen, während KI-gestützte Video-Tools (z. B. synthetische Avatare) den Produktionsaufwand für multimediale Inhalte senken.
    
- Im Bereich des **Rapid E-Learning** erlaubt KI eine nahezu instantane Umwandlung von Rohmaterialien (z. B. Transkripte von Vorträgen) in strukturierte Lernmodule oder Zusammenfassungen.
    
- Für den **Learner-Generated Content** dienen LLMs als 'Co-Creatoren', die Lernende bei der Strukturierung von Texten oder der Code-Generierung unterstützen und so die Hürde für die Eigenproduktion von Inhalten weiter senken (Kasneci et al., 2023; Zawacki-Richter et al., 2024).
